...
i18n.addTranslations('en', {
  ...
  apply: {
    ...
    submit: {
      ...
      description: '<p>In this section you can review all the information in your application. Please check that every section is accurate and complete, before you submit and pay for your application. You will not be able to make changes to your application after submitting. Your application will be incomplete until you have completed payment.</p>',
      confirmation: '<b>IMPORTANT</b>: Once you submit here you cannot return to edit your application. Your submission will be complete after completing payment. Your application will be considered incomplete until your payment is finalized.',
