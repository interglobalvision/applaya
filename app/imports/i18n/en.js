  ...
  apply: {
    ...
    sections: {
      ...
      proposal: {
        ...
        description: '<p>In this section, you will provide information about your gallery, selected artists and stand proposal that will allow the Selection Committee to make an informed decision with respect to your application.</p>',
      ...
      terms: {
        ...
        <p>Admission will be confirmed in writing after October 1st, 2015. Material Art Fair reserves the right to cancel any application that is accepted on the basis of false information or if the exhibitor fails to comply with these Conditions, and the exhibitor will remain liable for the full stand rental and any additional charges incurred by Material Art Fair.</p>\
        ...
        <p>Stand space and stand location at the exhibition will be allocated and determined by Material Art Fair and at Material Art Fair’s sole discretion. Material Art Fair may, in its discretion, change the location of allocated space, as well as slightly alter the shape of the stand if necessary.</p>\
        ...
        <p>Exhibitor recognizes that by participating in Material Art Fair, it assumes security risks that cannot be eliminated by security services provided by Material Art Fair. Security for individual stands is not included. Exhibitors are strongly advised to sufficiently protect all exhibition works and obtain adequate insurance coverage.</p>\
        ...
        <p>If you have a question about how to discard of something, please contact Material Art Fair show management. All hanging devices must be removed from the wall when dismantling the stand. No holes larger than a quarter inch may be cut or drilled into the wall without prior consent of Material Art Fair. Exhibitors will be charged for any damages deemed excessive by show management.</p>\
