...
<p>Cualquier error o problema, por favor comunícate directamente con nosotros al siguiente correo: <a href="mailto:applications@material-fair.com">applications@material-fair.com.</a></p>`,
    ...
    submit: {
      ...
      description: '<p>Por favor revisa la información que has ingresado. Puedes regresar y editar las veces que necesites o ingresar al área de expositores más tarde para completar tu solicitud.</p><p>Si has completado tu solicitud satisfactoriamente, por favor haz clic en “Entregar” para pagar la tasa de solicitud y finalizar la entrega. Por favor tomar en cuenta: en cuanto hagas clic en “Entregar”, no podrás hacer cambios a tu solicitud.</p>',
